...
INSERT INTO order_products VALUES(35,'8','3','4','4','1','17','2','9',now(),now(),'');
INSERT INTO order_products VALUES(36,'8','3','13','13','1','16','2','4',now(),now(),'');
INSERT INTO order_products VALUES(37,'5','2','10','10','1','16','2','2','2018-03-20','2018-03-20','');
INSERT INTO order_products VALUES(38,'8','1','16','16','1','16','3','10',now(),now(),'');
INSERT INTO order_products VALUES(39,'12','3','10','10','1','16','3','2',now(),now(),'');
INSERT INTO order_products VALUES(40,'10','3','11','11','2','12','3','2',now(),now(),'');

-- Season 3 products 19 to 27 (except 21, 24, 27)
INSERT INTO order_products VALUES(41,'12','3','19','19','1','17','2','9',now(),now(),'');
INSERT INTO order_products VALUES(42,'24','3','20','20','1','16','2','4',now(),now(),'');
INSERT INTO order_products VALUES(43,'53','3','22','22','1','16','2','2','2018-03-20','2018-03-20','');
INSERT INTO order_products VALUES(44,'82','3','19','19','1','16','3','10',now(),now(),'');
INSERT INTO order_products VALUES(45,'23','3','25','25','1','16','3','2',now(),now(),'');
INSERT INTO order_products VALUES(46,'53','3','23','23','2','12','3','2',now(),now(),'');

-- Seaason 4 products 28 to 36 (except 30, 33, 36)
INSERT INTO order_products VALUES(47,'12','3','28','28','1','13','35','10',now(),now(),'');
INSERT INTO order_products VALUES(48,'70','3','31','31','2','9','35','10',now(),now(),'');
INSERT INTO order_products VALUES(49,'70','3','34','34','1','13','35','10',now(),now(),'');
INSERT INTO order_products VALUES(50,'28','3','29','29','1','13','35','10',now(),now(),'');
INSERT INTO order_products VALUES(51,'27','3','28','28','2','9','35','10',now(),now(),'');
INSERT INTO order_products VALUES(52,'78','3','32','32','2','8','35','10',now(),now(),'');

-- season 5 products 37 to 54 (except 39, 42, 45, 48, 51, 54)
INSERT INTO order_products VALUES(53,'10','3','37','37','1','13','35','10',now(),now(),'');
INSERT INTO order_products VALUES(54,'70','3','38','38','2','9','35','10',now(),now(),'');
INSERT INTO order_products VALUES(55,'100','3','53','53','1','13','35','10',now(),now(),'');
INSERT INTO order_products VALUES(56,'30','3','49','49','1','13','35','10',now(),now(),'');
INSERT INTO order_products VALUES(57,'27','3','59','59','2','9','35','10',now(),now(),'');
INSERT INTO order_products VALUES(58,'65','3','52','52','2','8','35','10',now(),now(),'');

-- 55 to 63 (except 57 60 63)
-- id, quantity, order_product_statuses_id, original_product_lists_id, current_product_lists_id,product_types_id,purchase_price, orders_id, farmers_id, date, date, receipt
INSERT INTO order_products VALUES(59,'10','3','55','55','1','13','35','10',now(),now(),'');
INSERT INTO order_products VALUES(60,'70','3','56','56','2','9','35','10',now(),now(),'');
INSERT INTO order_products VALUES(61,'100','3','55','55','1','13','35','10',now(),now(),'');
INSERT INTO order_products VALUES(62,'30','3','61','61','1','13','35','10',now(),now(),'');
INSERT INTO order_products VALUES(63,'27','3','59','59','2','9','35','10',now(),now(),'');
INSERT INTO order_products VALUES(64,'65','3','62','62','2','8','35','10',now(),now(),'');
